...
int16_t AccYMis; 
int16_t AccZMis;
int panicButtonFlag=0;//Panic button
int flameFlag,doorFlag,movFlag,gasFlag,panicFlag,lcdFlag=0;//Flame sensor
...
int main( )
{
	...
	//GPIOA->CRL = (GPIOA->CRL & 0xFFFFF000) | 0x00000444;
	USARTInit();
...
void TIM2_IRQHandler(void){//Handler for TIM2 interruption
		...
		sprintf(message,"1 %05d %05d %05d %01d %01d %01d %01d %01d %01d",mpu1.acc_x,mpu1.acc_y, mpu1.acc_z,flameFlag,gasFlag,panicFlag,movFlag,doorFlag,lcdFlag);
		//sprintf(message,"%05d %05d %05d %01d %01d\r",mpu1.acc_x,mpu1.acc_y, mpu1.acc_z,panicButtonFlag,flameFlag);
