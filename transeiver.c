...
int main( )
{
    ...
    // Configure RX PIPE#1
    static const uint8_t nRF24_ADDR0[] = { 0xE7, 0x1C , 0xE3 };
    nRF24_SetAddr(nRF24_PIPE0, nRF24_ADDR0); // program address for RX pipe #1
    nRF24_SetRXPipe(nRF24_PIPE0, nRF24_AA_OFF, 31); // Auto-ACK: disabled, payload length: 5 bytes
    
    static const uint8_t nRF24_ADDR1[] = { 0xE6, 0x1B , 0xE2 };
